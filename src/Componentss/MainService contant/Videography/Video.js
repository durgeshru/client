...
export default function Video() {
  const mainText = { Text: "Video Production Company" }
  const Secondtext = { Text: "In the fast-paced world of digital media and marketing, video content is king. Companies and people alike understand how effective video is at getting their point across, holding viewers' attention, and creating a lasting impression.Video Ads That Grab Attention Because Your Brand Deserves To Shine " }
